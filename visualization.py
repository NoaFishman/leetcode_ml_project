...
# Show plot
# plt.show()
plt.savefig('plots/difficulty + is premium.jpg')
...
plt.tight_layout()
# plt.show()
plt.savefig('plots/difficulty + acceptance rate.jpg')
...
plt.tight_layout()
# plt.show()
plt.savefig('plots/difficulty + acceptance rate separate.jpg')
...
plt.tight_layout()
# plt.show()
plt.savefig('plots/difficulty + discuss count.jpg')
...
plt.tight_layout()
# plt.show()
plt.savefig('plots/difficulty + discuss count separate.jpg')
...
# plt.show()
plt.savefig('plots/premium + difficulty.jpg')
...
plt.tight_layout()
# plt.show()
plt.savefig('plots/companies + difficulty.jpg')
...
plt.tight_layout()
# plt.show()
plt.savefig('plots/topics + difficulty.jpg')
...
plt.tight_layout()
# plt.show()
plt.savefig('plots/companies + related topics (ratio).jpg')
...
plt.tight_layout()
# plt.show()
plt.savefig('plots/most common words.jpg')
